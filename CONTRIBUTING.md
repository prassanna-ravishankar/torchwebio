...
If you experience bugs or general issues with `torchwebio`, please have a look
...
You can help improve `torchwebio` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`torchwebio` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `torchwebio`'s files. While this mechanism can
...
5. Install [pre-commit]:
   ...
   `torchwebio` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/torchwebio
[issue tracker]: https://github.com/<USERNAME>/torchwebio/issues
